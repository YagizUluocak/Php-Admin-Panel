...
$s_id = $_GET["s_id"];
$soru = new soru();
$sorular = $soru->soruIdGetir($_GET["s_id"]);
...
if(isset($_POST["submit"]))
{
  ...
  if($sorular->soruDuzenle($s_id, $soru_adi, $soru_cevap, $soru_durum))
    {
     
        echo "<script>window.location.href='s.s.s.duzenle.php?durum=ok&s_id=$s_id';</script>";
    }
    else
    {
        
        echo "<script>window.location.href='s.s.s.duzenle.php?durum=no&s_id=$s_id';</script>";
    }
}
?>
<head>
...
<div class="right_col" role="main">
    <div class="">
        <div class="page-title">
            ...
            <h3>SIk Sorulan Sorular Düzenleme</h3>
            </div>
        </div>
        <div class="row">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" id="soru_adi" name="soru_adi" required="required"  value="<?php echo $sorular->soru_adi?>">
                        </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea class="form-control col-md-7 col-xs-12" name="soru_cevap"><?php echo $sorular->soru_cevap?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" id="soru_durum" name="soru_durum" required="required" value="<?php echo $sorular->soru_durum?>">
                        </div>
                      </div>
