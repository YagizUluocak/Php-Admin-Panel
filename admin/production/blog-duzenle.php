...
$blog = new blog();
$bloglar = $blog->blogIdGetir($_GET["blog_id"]);
...
if(isset($_POST["submit"]))
{
  ...
  if($blog->blogDuzenle($blog_id,$blog_adi, $blog_icerik, $blog_descr, $blog_keywords, $onay, $blog_resim))
    {
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" id="blog_adi" name="blog_adi" required="required" value="<?php echo $bloglar->blog_adi?>">
                        </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="blog_icerik" class="form-control col-md-7 col-xs-12" name="blog_icerik"><?php echo $bloglar->blog_icerik?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <img  src="./images/blog/<?php echo $bloglar->blog_resim ?>" class="img-fluid" style="width:200px; margin-bottom:12px;" alt="">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" id="onay" name="onay" required="required" value="<?php echo $bloglar->onay?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="blog_descr">Description</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea class="form-control col-md-7 col-xs-12" name="blog_descr"><?php echo $bloglar->blog_descr?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" id="blog_keywords" name="blog_keywords" required="required" value="<?php echo $bloglar->blog_keywords?>">
                        </div>
                      </div>
