...
$sayfa = new sayfa();
$sayfalar = $sayfa->sayfaIdGetir($_GET["sayfa_id"]);
...
if(isset($_POST["submit"]))
{
  ...
  if($sayfa->sayfaDuzenle($sayfa_id, $baslik, $sayfa_url, $sayfa_resim, $sayfa_icerik, $sayfa_keywords, $sayfa_descr, $sayfa_durum))
    {
     
      echo "<script>window.location.href='sayfa-duzenle.php?durum=ok&sayfa_id=$sayfa_id';</script>";    
    }
    else
    {
      echo "<script>window.location.href='saayfa-duzenle?durum=no&sayfa_id=$sayfa_id';</script>";
    }
}
?>
<head>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        <img  src="./images/sayfa/<?php echo $sayfalar->sayfa_resim ?>" class="img-fluid" style="width:200px; margin-bottom:12px;" alt="<?php echo $sayfalar->baslik?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" id="baslik" name="baslik" required="required" value="<?php echo $sayfalar->baslik?>" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" id="sayfa_url" name="sayfa_url" required="required" value="<?php echo $sayfalar->sayfa_url?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php echo $sayfalar->sayfa_icerik?>
                          </textarea>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" id="sayfa_keywords" name="sayfa_keywords" required="required" value="<?php echo $sayfalar->sayfa_keywords?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" id="sayfa_descr" name="sayfa_descr" required="required" value="<?php echo $sayfalar->sayfa_descr?>">
                        </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" id="sayfa_durum" name="sayfa_durum" required="required" value="<?php echo $sayfalar->sayfa_durum?>"> 
                        </div>
                      </div>
